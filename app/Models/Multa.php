...
class Multa extends Model
{
     ...
     */
    const DELETED_AT = 'dt_exclusao_multa';

     /**
     * <b>primaryKey</b> Informa qual a é a chave primaria da tabela
     */
    protected $primaryKey = "pk_multa";

     /**
     * <b>dates</b> Serve para tratar todos os campos de data para serem também um objeto do tipo Carbon(biblioteca de datas)
     */

    protected $dates = ['dt_cadastro_multa', 'dt_atualizacao_multa', 'dt_exclusao_multa'];

     /**
     * <b>fillable</b> Informa quais colunas é permitido a inserção de dados (MassAssignment)
     *  
     */
    protected $fillable  = ['vl_multa',
                            'nr_parcelas_multa',
                            'vl_multa_pago',
                            'ds_ativo_multa',
                            'fk_pk_banco',
    ...
    */
    ...
    public $rules = [
        'vl_multa'            => 'bail|required',
        'nr_parcelas_multa'   => 'bail|required|numeric',
        'vl_multa_pago'       => 'bail|nullable|min:0', // TODO: avaliar mudar para nullable, pois é calculado
        'ds_ativo_multa'      => 'bail|required|numeric|min:0|max:1',
        'ds_observacao_multa' => 'bail|nullable|min:5',  
        'dt_calculo_multa'    => 'bail|required',  
        'fk_pk_banco'         => 'bail|numeric|min:1',    
        'fk_pk_pena'          => 'bail|required|numeric',
        'fk_pk_tipo_multa'    => 'bail|required|numeric|min:1',
        'ds_agencia_multa'    => 'bail|nullable|required_with:fk_pk_banco',
        'ds_conta_multa'      => 'bail|nullable|required_with:ds_agencia_multa',
        'dt_cadastro_multa'   => 'bail|date',
        'dt_atualizacao_multa'=> 'bail|date',
        'dt_exclusao_multa'   => 'bail|date',
    ];
    ...
    */
    public $messages = [
        'vl_multa.required'          => 'O campo valor é obrigatório !',
        'nr_parcelas_multa.required' => 'O campo qtdeParcelas é obrigatório !',
        'nr_parcelas_multa.numeric'  => 'O campo qtdeParcelas deve conter apenas valores numericos!',
        'fk_pk_tipo_multa.required'  => 'O campo tipo é obrigatório !',
        'fk_pk_tipo_multa.numeric'   => 'O campo tipo deve conter apenas valores numericos!',
        'fk_pk_pena.required'        => 'O campo pena é obrigatório !',
        'fk_pk_pena.numeric'         => 'O campo pena deve conter apenas valores numericos!',
        'dt_calculo_multa.required'  => 'O campo dataCalculoé obrigatório !',
        'ds_ativo_multa.required'    => 'O campo ativo é obrigatório !',
        'ds_ativo_multa.numeric'     => 'O campo ativo deve conter apenas valores numericos!',
        'ds_observacao_multa.min'    => 'O campo observacoes deve possui o valor minimo de 5 caracteres!',
        'ds_agencia_multa.required_with'   => 'O campo agencia deve ser preenchido junto com o banco',
        'ds_conta_multa.required_with'     => 'O campo conta deve ser preenchido junto com o banco'
    ];
    ...
    */
    public $collection = "\App\Http\Resources\MultaResource::collection";

    /**
     * <b>resource</b>
    */
    public $resource = "\App\Http\Resources\MultaResource";
    ...
    */
    public $map = [
        'id'               => 'pk_multa',
        'pena'             => 'fk_pk_pena',
        'tipo'             => 'fk_pk_tipo_multa',
        'valorTotal'       => 'vl_multa',
        'qtdeParcelas'     => 'nr_parcelas_multa',
        'valorPago'        => 'vl_multa_pago',
        'ativo'            => 'ds_ativo_multa',
        'banco'            => 'fk_pk_banco',
        'agencia'          => 'ds_agencia_multa',
        'conta'            => 'ds_conta_multa',
        'observacoes'      => 'ds_observacao_multa',
        'dataCalculo'      => 'dt_calculo_multa',
