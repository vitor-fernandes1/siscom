...
class Prioridade extends Model
{
    ...
    */
    const DELETED_AT = 'dt_exclusao_prioridade';
    ...
    */
    protected $dates = ['dt_cadastro_prioridade', 'dt_atualizacao_prioridade', 'dt_exclusao_prioridade'];
    ...
    */
    public $table = "siscom_prioridade";
    ...
    */
    ...
    public $rules = [
        'ds_prioridade'             => 'bail|required|max:50',
        'dt_cadastro_prioridade'    => 'bail|date',
        'dt_atualizacao_prioridade' => 'bail|date',
        'dt_exclusao_prioridade'    => 'bail|date',
    ];
    ...
    */
    public $messages = [
        'ds_prioridade.required'      => 'O campo prioridade é obrigatório !',
        'ds_prioridade.max'           => 'O campo prioridade deve conter no maximo 50 caracteres !',
    ];
