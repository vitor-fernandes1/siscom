...
class TipoMulta extends Model
{
    ...
    */
    ...
    const DELETED_AT = "dt_exclusao_tipo_multa";

    /**
     * <b>table</b> Informa qual é a tabela que o modelo irá utilizar
    */

    public $table = "sigmp_tipo_multa";

    /**
     * <b>primaryKey</b> Informa qual a é a chave primaria da tabela
    */

    protected $primaryKey="pk_tipo_multa"; 
    ...
    protected $fillable = ['nm_tipo_multa'];

    /**
     * <b>dates</b> Serve para tratar todos os campos de data para serem também um objeto do tipo Carbon(biblioteca de datas)
     */
    protected $dates = ['dt_cadastro_tipo_multa', 'dt_atualizacao_tipo_multa', 'dt_exclusao_tipo_multa'];
    ...
    */
    ...
    public $rules = [
        'nm_tipo_multa'             => 'bail|required|',
        'dt_cadastro_tipo_multa'    => 'bail|date',
        'dt_atualizacao_tipo_multa' => 'bail|date',
        'dt_exclusao_tipo_multa'    => 'bail|date',
    ];
    ...
    */
    ...
    public $messages = [
        'nm_tipo_multa.required'          => 'Nome: O campo Nome é obrigatório !',
    ];
    ...
    */
    ...
    public $collection = "\App\Http\Resources\TipoMultaResource::collection";

    /**
     * <b>resource</b>
    */

    public $resource = "\App\Http\Resources\TipoMultaResource";
    ...
    */
    ...
    public $map = [
        'id'               => 'pk_tipo_multa',
        'nome'             => 'nm_tipo_multa',
        'data_cadatro'     => 'dt_cadastro_tipo_multa',
        'data_atualizacao' => 'dt_atualizacao_tipo_multa',
        'data_exclusao'    => 'dt_exclusao_tipo_multa' 
    ];
