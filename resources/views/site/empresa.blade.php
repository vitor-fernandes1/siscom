            ...
            <table class="table">
                ...
                <tbody>
                    @foreach($recuperandoDados as $item)
                        <tr>
                            <th scope="row">{{ $item->pk_empresa }}</th>
                            <td>{{ $item->nm_empresa }}</td>
                            <td>{{ $item->ds_endereco_empresa }}</td>
                            <td>{{ $item->ds_cnpj_empresa }}</td>
                            <td>
                            
                            <a href="/equipamento/{{ $item->pk_empresa }}"><button type="button" class="btn btn-primary"><i class="fas fa-edit"></i> Editar</button></a>
                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modal-danger" data-pk="{{ $item->pk_empresa }}"><i class="fas fa-edit"></i> Deletar</button>
